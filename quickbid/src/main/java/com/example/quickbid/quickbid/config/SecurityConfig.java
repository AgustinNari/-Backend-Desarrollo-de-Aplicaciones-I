	...
	SecurityFilterChain securityFilterChain(HttpSecurity http, JwtAuthenticationFilter jwt,
		...
		return http
				...
				.authorizeHttpRequests(auth -> auth
						.requestMatchers("/api/auth/registro/**", "/api/auth/login", "/api/auth/refresh", "/api/auth/recuperar-clave", "/api/auth/cambiar-clave", "/api/auth/logout", "/actuator/health").permitAll()
