...
public interface NotificacionAppRepository extends JpaRepository<NotificacionApp, Long> {
	...
	Optional<NotificacionApp> findByIdAndCuentaId(Long id, Long cuentaId);

	List<NotificacionApp> findAllByCuentaIdAndLeidaFalseOrderByCreatedAtDesc(Long cuentaId);
}
